    ...
    return(
        <section className="py-24 px-6 bg-black text-white relative overflow-hidden">
            <div className="absolute inset-0 opacity-5">
                <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#ffa700] rounded-full blur-3xl"></div>
                <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#ffa700] rounded-full blur-3xl"></div>
            </div>

            <div className="max-w-6xl mx-auto relative z-10">
                <div className="text-center mb-16">
                    <span className="text-[#ffa700] text-sm font-bold tracking-widest uppercase mb-4 block">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                    <div className="bg-gradient-to-br from-gray-900 to-black p-8 rounded-2xl border border-gray-800 hover:border-[#ffa700] transition-all duration-300 group">
                        <div className="w-16 h-16 bg-[#ffa700] rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="bg-gradient-to-r from-[#ffa700]/10 to-[#ffa700]/5 border border-[#ffa700]/20 rounded-2xl p-8 md:p-12">
                    <div className="flex flex-col md:flex-row items-center gap-8">
                        <div className="flex-1">
                        <h3 className="text-2xl md:text-3xl font-bold mb-4">
                            Le Résultat : <span className="text-[#ffa700]">Trop Doux Récup</span>
                        </h3>
                        ...
                        <div className="flex gap-4">
                            <div className="text-center">
                                <div className="text-4xl font-bold text-[#ffa700] mb-2">3</div>
                                <div className="text-sm text-gray-400">Spécialistes</div>
                            </div>
                            <div className="w-px bg-gray-700"></div>
                            <div className="text-center">
                                <div className="text-4xl font-bold text-[#ffa700] mb-2">1</div>
                                <div className="text-sm text-gray-400">Équipe Unifiée</div>
                            </div>
                            <div className="w-px bg-gray-700"></div>
                            <div className="text-center">
                                <div className="text-4xl font-bold text-[#ffa700] mb-2">100%</div>
