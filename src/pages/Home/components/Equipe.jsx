        ...
        <section id="team" className="py-12 sm:py-16 lg:py-24 px-4 sm:px-6 bg-gradient-to-b from-white to-gray-50">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-12 sm:mb-16 px-4">
                    <span className="text-[#ffa700] text-xs sm:text-sm font-bold tracking-widest uppercase mb-3 sm:mb-4 block">
                        Notre Équipe
                    </span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 px-4 sm:px-0">
                    {developpeurs.map((dev, index) => (
                        <div
                            key={index}
                            className="group bg-white rounded-xl sm:rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 hover:border-[#ffa700] hover:-translate-y-1 sm:hover:-translate-y-2"
                        >
                            {/* Image */}
                            ...
                            <div className="p-4 sm:p-6">
                                ...
                                <div className="inline-block bg-[#ffa700] text-black px-3 sm:px-4 py-1 rounded-full text-xs sm:text-sm font-bold mb-3 sm:mb-4">
                                    {dev.role}
                                </div>
                                ...
                                <div className="flex flex-col xs:flex-row gap-3 sm:gap-4 pt-4 border-t border-gray-100">
                                    <a
                                        href={dev.linkedin}
                                        className="flex-1 flex items-center justify-center gap-2 bg-black text-white px-3 sm:px-4 py-2 rounded-lg hover:bg-[#ffa700] hover:text-black transition-colors duration-300 font-semibold text-xs sm:text-sm min-h-[44px]"
