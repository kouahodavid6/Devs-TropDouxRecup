    ...
    return(
        <header className="relative min-h-screen flex items-center justify-center bg-black text-white overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-10">
                ...
                <div className="absolute bottom-20 right-10 w-96 h-96 bg-[#ffa700] rounded-full blur-3xl"></div>
            </div>
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
                ...
                <button
                    ...
                    className="group inline-flex items-center gap-2 bg-[#ffa700] text-black px-8 py-4 rounded-full font-bold text-lg hover:bg-[#ff9100] transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-[#ffa700]/50"
                >
                    Rencontrer l'Équipe
            ...
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
                <ChevronDown className="w-6 h-6 text-[#ffa700]" />
            </div>
        </header>
    );
}
