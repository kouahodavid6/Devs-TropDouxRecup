const developpeurs = [
    ...
    },
    {
        ...
        bio: "Expert dans la construction d'architectures serveur robustes et évolutives. Spécialisé dans la conception d'API et l'optimisation des bases de données.",
